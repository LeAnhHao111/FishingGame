...
// Check va cham
bool Level3::CheckCollision(std::shared_ptr<SpriteAnimation> sprite1, std::shared_ptr<Fish> sprite2)
{
...
void Level3::CheckHookCollision()
{
...
void Level3::Init()
{
	...
	auto texture = ResourceManagers::GetInstance()->GetTexture("bg_sea3.jpg");
	...
	buttonnext->SetOnClick([this]() {
		GameStateMachine::GetInstance()->ChangeState(StateType::LEVEL4);
		});
	...
	m_currentPlayerState = PlayerState3::IDLE3;
...
void Level3::HandleKeyEvents(SDL_Event& e)
{
...
void Level3::HandleTouchEvents(SDL_Event& e)
{
...
void Level3::HandleMouseMoveEvents(int x, int y)
{
}
...
void Level3::Update(float deltaTime)
{
	...
	{
	case 1: // left 
		if (m_currentPlayerState & (PlayerState3::IDLE3 | MOVE_RIGHT3))
		{
			m_currentPlayerState = PlayerState3::MOVE_LEFT3;
		}
		break;
	case 1 << 1: // down
		if (m_currentPlayerState & (PlayerState3::IDLE3 | PlayerState3::MOVE_LEFT3 | PlayerState3::MOVE_RIGHT3))
		{
			m_currentPlayerState = PlayerState3::CAST3;
		}
		break;
	case 1 << 2: // right
		if (m_currentPlayerState & (PlayerState3::IDLE3 | MOVE_LEFT3))
		{
			m_currentPlayerState = PlayerState3::MOVE_RIGHT3;
		}
		break;
	case 1 << 3: // up
	...
	if (!(m_KeyPress & 0b101) && // none of left and right are pressed
		!(m_currentPlayerState & (PlayerState3::CAST3 | REEL3))) // not casting or reeling
	{
		m_currentPlayerState = PlayerState3::IDLE3;
	}
	...
	case PlayerState3::CAST3:
		...
		{
			m_currentPlayerState = PlayerState3::REEL3;
			break;
		}
	...
	if (m_score >= 1250 && !m_isMissionCompleted)
	{
