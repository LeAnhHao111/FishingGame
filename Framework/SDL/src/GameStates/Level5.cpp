...
// Check va cham
bool Level5::CheckCollision(std::shared_ptr<SpriteAnimation> sprite1, std::shared_ptr<Fish> sprite2)
{
...
void Level5::CheckHookCollision()
{
...
void Level5::Init()
{
	...
	auto texture = ResourceManagers::GetInstance()->GetTexture("bg_sea5.jpg");
	...
	fish0->m_fishAnimation = std::make_shared<SpriteAnimation>(texture, 1, 3, 1, 0.5f);
	fish0->SetSize(80, 80);
	fish0->Set2DPosition(530, 560);
	m_fish.push_back(fish0);


	fish0 = std::make_shared<Fish>(Fish0);
	texture = ResourceManagers::GetInstance()->GetTexture("fish1.png");
	fish0->m_fishAnimation = std::make_shared<SpriteAnimation>(texture, 1, 2, 1, 0.2f);
	fish0->SetSize(24, 12);
	fish0->Set2DPosition(295, 510);
	m_fish.push_back(fish0);
	...
	m_currentPlayerState = PlayerState5::IDLE5;
...
void Level5::HandleEvents()
{
}

void Level5::HandleKeyEvents(SDL_Event& e)
{
...
void Level5::HandleTouchEvents(SDL_Event& e)
{
...
void Level5::HandleMouseMoveEvents(int x, int y)
{
}
...
void Level5::Update(float deltaTime)
{
	...
	{
	case 1: // left 
		if (m_currentPlayerState & (PlayerState5::IDLE5 | MOVE_RIGHT5))
		{
			m_currentPlayerState = PlayerState5::MOVE_LEFT5;
		}
		break;
	case 1 << 1: // down
		if (m_currentPlayerState & (PlayerState5::IDLE5 | PlayerState5::MOVE_LEFT5 | PlayerState5::MOVE_RIGHT5))
		{
			m_currentPlayerState = PlayerState5::CAST5;
		}
		break;
	case 1 << 2: // right
		if (m_currentPlayerState & (PlayerState5::IDLE5 | MOVE_LEFT5))
		{
			m_currentPlayerState = PlayerState5::MOVE_RIGHT5;
		}
		break;
	case 1 << 3: // up
	...
	if (!(m_KeyPress & 0b101) && // none of left and right are pressed
		!(m_currentPlayerState & (PlayerState5::CAST5 | REEL5))) // not casting or reeling
	{
		m_currentPlayerState = PlayerState5::IDLE5;
	}
	...
	case PlayerState5::CAST5:
		...
		{
			m_currentPlayerState = PlayerState5::REEL5;
			break;
		}
	...
	if (m_score >= 2600 && !m_isMissionCompleted)
	{
...
void Level5::Draw(SDL_Renderer* renderer)
{
